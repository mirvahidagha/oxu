package com.mirvahidagha.betterbet.tabs.behavior;
...
public class NavigationTabBarBehavior extends com.mirvahidagha.betterbet.tabs.behavior.VerticalScrollingBehavior<NavigationTabBar> {
