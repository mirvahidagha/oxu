...
package com.mirvahidagha.betterbet.tabs.ntb;
...
import com.mirvahidagha.betterbet.tabs.behavior.NavigationTabBarBehavior;
...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
            ...
            if (isInEditMode()) {
                ...
                try {
                    ...
                    if (previewColors == null)
                        previewColors =
                                typedArray.getResources().getStringArray(R.array.tab_colors);
    ...
    //todo viewPager-in adapteri settings və other apps-i (3-cü və 4-cü tab-ı) başqa fraqment ilə dolduracaq.
