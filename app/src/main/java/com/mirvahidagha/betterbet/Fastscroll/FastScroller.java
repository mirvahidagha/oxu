package com.mirvahidagha.betterbet.Fastscroll;
...
import com.mirvahidagha.betterbet.Fastscroll.viewprovider.DefaultScrollerViewProvider;
import com.mirvahidagha.betterbet.Fastscroll.viewprovider.ScrollerViewProvider;
...
public class FastScroller extends LinearLayout {
    ...
    private void setRecyclerViewPosition(float relativePos) {
        ...
        if (titleProvider != null && bubbleTextView != null) {
            ...
            bubbleTextView.setTypeface(bold);
        }
    }
